...
public partial class QuickTypeData
{
	#region Properties
	...
	public QuickTypeData(TypeDefinition type)
	{
		...
		this.GenericParameters = GenericParameterData.CreateArray(type.GenericParameters);
	...
	public QuickTypeData(TypeReference type)
	{
		List<string> generics = Utility.GetGenericParametersString(type.GenericParameters);
