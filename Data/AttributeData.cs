...
public class AttributeData
{
	...
	public AttributeData(CustomAttribute attr)
	{
		int i = 0;
	...
	public static List<AttributeData> CreateArray(Collection<CustomAttribute> attrs)
	{
		List<AttributeData> results = new List<AttributeData>();
		
		foreach(CustomAttribute attr in attrs)
		{
			results.Add(new AttributeData(attr));
		}
	...
	private List<string> GetParameterDeclaration(AttributeData info)
	{
